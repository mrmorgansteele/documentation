...
___
## [Drush package 'drush-gdpr-dumper'](https://packagist.org/packages/druidfi/drush-gdpr-dumper)
<ReviewDate date="2024-10-18" />

**Issue:** Breaks `drush-sql-dump` command. It results with following error `The '--column-statistics' option does not exist.`
